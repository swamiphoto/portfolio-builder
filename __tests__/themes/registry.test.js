...
describe('theme registry', () => {
  it('registers kyoto, manhattan, provence, florence, amsterdam and blantyre', () => {
    expect(Object.keys(THEMES).sort()).toEqual(['amsterdam', 'blantyre', 'florence', 'kyoto', 'manhattan', 'provence'])
    expect(THEME_LIST.map(t => t.id).sort()).toEqual(['amsterdam', 'blantyre', 'florence', 'kyoto', 'manhattan', 'provence'])
  })
