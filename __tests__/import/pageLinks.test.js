...
it('dedupes duplicate pageRefs pointing at the same page into one pageId', () => {
  const pages = [
    { id: 'p_land', source: { sourceUrl: 'https://x.com/portfolio/landscapes' }, blocks: [] },
    { id: 'p_port', source: { sourceUrl: 'https://x.com/portfolio' }, blocks: [
      { type: 'page-gallery', source: 'manual', pageIds: [], pageRefs: [
        'https://x.com/portfolio/landscapes',
        'https://x.com/portfolio/landscapes',
      ] },
    ] },
  ]
