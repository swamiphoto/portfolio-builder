// common/themes/tofino.js
// Tofino — the surf-journal theme: a soft sage ground, typewriter mono body
...
// layout (TofinoOffsetGallery) with generous air between rows.
const TOFINO_FONTS = [
  { id: 'mono', label: 'Mono' },
...
export const tofino = {
  ...
  tokens: {
    ...
    '--tofino-frame': '#b1b6a2',     // keyline frame around every photo
    fonts: {
  ...
  overrides: {
    ...
    // Photo sets lead with the staggered two-column Offset scatter (the Tofino
    ...
    text: { defaultAlign: 'left', aligns: ['left', 'center'], defaultFont: 'mono', fonts: TOFINO_FONTS },
    testimonial: { defaultFont: 'mono', fonts: TOFINO_FONTS, defaultQuoteStyle: 'regular' },
