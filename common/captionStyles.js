...
export function captionStyleCss(id) {
  ...
  if (id === 'mono') return { fontFamily: '"Roboto Mono", "Geist Mono", ui-monospace, monospace', fontStyle: 'normal', fontSize: '0.95rem', letterSpacing: '0.02em', color: 'var(--theme-text-muted, #6b7280)' }
